package SolunaLauncher.proxy;
/*
 *  When compiled add resources folder to jar file
 */
...
public class YggdrasilProxyHandler implements HttpProxyHandler, SocksProxyHandler {
	public static String authServer = "mineshafter.info";//Create own server at google appspot create domain at dot.tk and if needed use ooowebhost to host some files
