...
import SolunaLauncher.util.SimpleRequest;
...
public class Util {
	...
	public static File getWorkingDirectory() {
		...
		case LINUX:
		case SOLARIS:
			workingDirectory = new File(userHome, ".SolunaLauncher/");
			break;
		case WINDOWS:
			String applicationData = System.getenv("APPDATA");
			String folder = applicationData != null ? applicationData : userHome;
			workingDirectory = new File(folder, ".SolunaLauncher/");
			break;
		case MACOS:
			workingDirectory = new File(userHome, "Library/Application Support/SolunaLauncher");
			break;
		default:
			workingDirectory = new File(userHome, "SolunaLauncher/");
		}
	...
	public static float getCurrentBootstrapVersion() {
		try {
			...
			System.out.println("Error while relesing Half-Life 3:");
			e.printStackTrace();
			return 0;
		}
	}
